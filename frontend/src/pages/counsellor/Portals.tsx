...
const LIST = [
  ...
  { label:'DHM',          icon:'📋', path:'/deputy-hm/dashboard', border:'#0ea5e9', bg:'#f0f9ff' },
  { label:'Nurse',        icon:'🏥', path:'/nurse/dashboard',     border:'#ec4899', bg:'#fdf2f8' },
...
export default function CounsellorPortals() {
